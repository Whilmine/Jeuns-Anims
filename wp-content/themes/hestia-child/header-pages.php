...
<head>
    ...
    <? } else if ($pageId == 16) {
        ?><title> Jeun's Anim's - Page équipe </title><? } else if ($pageId == 213) {
        ?><title> Jeun's Anim's - Page aide </title><? } else if ($pageId == 118) {
        ?><title> Jeun's Anim's - Page mentions légales </title><? } else if ($pageId == 126) {
